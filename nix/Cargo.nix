...
rec {
  ...
  crates = {
    ...
    "edit_tree 0.1.1 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        crateName = "edit_tree";
        version = "0.1.1";
        edition = "2018";
    ...
    "sticker2 0.1.1 (path+file:///home/daniel/git/sticker2/sticker2)"
      = rec {
        crateName = "sticker2";
        version = "0.1.1";
        edition = "2018";
    ...
    "sticker2-utils 0.1.0 (path+file:///home/daniel/git/sticker2/sticker2-utils)"
      = rec {
    ...
    "tch 0.1.5 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = [
          ...
          {
            name = "zip";
            packageId = "zip 0.5.3 (registry+https://github.com/rust-lang/crates.io-index)";
          }
        ];
        features = {
          "python" = [ "cpython" ];
    ...
    "wordpieces 0.2.0 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
